...
//--------------------------------------------------------------------------------------------------------------------------------------
	...
	#define NB_MAX_POLYGONS (10 + MAX_NB_FOES)	// Nombre maximal de polygones
	...
	#define OBSTACLE_MARGIN (250)				// Marge du centre du robot avec un obstacle
	...
	#define ASTAR_OPTIMISATION_2		1		// Activation de l'optimisation de trajectoires	(Optimisation par défaut)
	...
	#define ASTAR_OPTIMISATION		0		// Activation de l'optimisation de trajectoires
...
//--------------------------------------------------------------------------------------------------------------------------------------
	...
	static astar_node_t astar_nodes[NB_NODES] =
	{
		...
		//Rangée [A]
		(astar_node_t){ A1, {300,  225}, (1ULL<<A2)|(1ULL<<B1)|(1ULL<<C1)},
		(astar_node_t){ A2, {600,  225}, (1ULL<<A1)|(1ULL<<A3)|(1ULL<<B1)|(1ULL<<C1)},
		(astar_node_t){ A3, {900,  225}, (1ULL<<A2)|(1ULL<<A4)|(1ULL<<B1)|(1ULL<<B2)|(1ULL<<C2)},
		(astar_node_t){ A4, {1400, 225}, (1ULL<<A3)|(1ULL<<B2)},

		//Rangée [B]
		(astar_node_t){ B1, {600,  550}, (1ULL<<A1)|(1ULL<<A2)|(1ULL<<A3)|(1ULL<<C1)|(1ULL<<C2)|(1ULL<<D1)},
		(astar_node_t){ B2, {1250, 550}, (1ULL<<A3)|(1ULL<<A4)|(1ULL<<C2)|(1ULL<<D2)},

		//Rangée [C]
		(astar_node_t){ C1, {300,  750}, (1ULL<<A1)|(1ULL<<A2)|(1ULL<<B1)|(1ULL<<D1)|(1ULL<<E1)},
		(astar_node_t){ C2, {900,  750}, (1ULL<<A3)|(1ULL<<B1)|(1ULL<<B2)|(1ULL<<D1)|(1ULL<<D2)|(1ULL<<E2)},

		//Rangée [D]
		(astar_node_t){ D1, {600,  900}, (1ULL<<B1)|(1ULL<<C1)|(1ULL<<C2)|(1ULL<<E1)|(1ULL<<E2)|(1ULL<<F1)},
		(astar_node_t){ D2, {1250, 900}, (1ULL<<B2)|(1ULL<<C2)|(1ULL<<E2)|(1ULL<<F2)},

		//Rangée [E]
		(astar_node_t){ E1, {300,  1150}, (1ULL<<C1)|(1ULL<<D1)|(1ULL<<F1)|(1ULL<<G1)},
		(astar_node_t){ E2, {900,  1150}, (1ULL<<C2)|(1ULL<<D1)|(1ULL<<D2)|(1ULL<<F1)|(1ULL<<F2)|(1ULL<<G2)},

		//Rangée [F]
		(astar_node_t){ F1, {600,  1300}, (1ULL<<D1)|(1ULL<<E1)|(1ULL<<E2)|(1ULL<<G1)|(1ULL<<G2)|(1ULL<<H1)},
		(astar_node_t){ F2, {1250, 1300}, (1ULL<<D2)|(1ULL<<E2)|(1ULL<<G2)},

		//Rangée [G]
		(astar_node_t){ G1, {300,  1500}, (1ULL<<E1)|(1ULL<<F1)|(1ULL<<H1)|(1ULL<<I1)},
		(astar_node_t){ G2, {900,  1500}, (1ULL<<E2)|(1ULL<<F1)|(1ULL<<F2)|(1ULL<<H1)|(1ULL<<H2)|(1ULL<<I2)},

		//Rangée [H]
		(astar_node_t){ H1, {600,  1700}, (1ULL<<J1)|(1ULL<<I1)|(1ULL<<I2)|(1ULL<<G1)|(1ULL<<G2)|(1ULL<<F1)},
		(astar_node_t){ H2, {1250, 1700}, (1ULL<<J2)|(1ULL<<I2)|(1ULL<<G2)},

		//Rangée [I]
		(astar_node_t){ I1, {300,  1850}, (1ULL<<K1)|(1ULL<<J1)|(1ULL<<H1)|(1ULL<<G1)},
		(astar_node_t){ I2, {900,  1850}, (1ULL<<K2)|(1ULL<<J1)|(1ULL<<J2)|(1ULL<<H1)|(1ULL<<H2)|(1ULL<<G2)},

		//Rangée [J]
		(astar_node_t){ J1, {600,  2100}, (1ULL<<L1)|(1ULL<<K1)|(1ULL<<K2)|(1ULL<<I1)|(1ULL<<I2)|(1ULL<<H1)},
		(astar_node_t){ J2, {1250, 2100}, (1ULL<<L2)|(1ULL<<K2)|(1ULL<<I2)|(1ULL<<H2)},

		//Rangée [K]
		(astar_node_t){ K1, {300,  2250}, (1ULL<<M1)|(1ULL<<M2)|(1ULL<<L1)|(1ULL<<J1)|(1ULL<<I1)},
		(astar_node_t){ K2, {900,  2250}, (1ULL<<M3)|(1ULL<<L1)|(1ULL<<L2)|(1ULL<<J1)|(1ULL<<J2)|(1ULL<<I2)},

		//Rangée [L]
		(astar_node_t){ L1, {600,  2450}, (1ULL<<M1)|(1ULL<<M2)|(1ULL<<M3)|(1ULL<<K1)|(1ULL<<K2)|(1ULL<<J1)},
		(astar_node_t){ L2, {1250, 2450}, (1ULL<<M3)|(1ULL<<M4)|(1ULL<<K2)|(1ULL<<J2)},

		//Rangée [M]
		(astar_node_t){ M1, {300,  2725}, (1ULL<<M2)|(1ULL<<L1)|(1ULL<<K1)},
		(astar_node_t){ M2, {600,  2725}, (1ULL<<M1)|(1ULL<<M3)|(1ULL<<L1)|(1ULL<<K1)},
		(astar_node_t){ M3, {900,  2725}, (1ULL<<M2)|(1ULL<<M4)|(1ULL<<L1)|(1ULL<<L2)|(1ULL<<K2)},
		(astar_node_t){ M4, {1400, 2725}, (1ULL<<M3)|(1ULL<<L2)},
	...
	static astar_neighbor_t astar_curves[NB_NODES] =
	{
		...
		//Rangée [A]
		//On est en A1, les courbes sont autorisées lorsque l'on vient de A2 ou de B1
		/*A1*/  (1ULL<<A2)|(1ULL<<B1)|(1ULL<<C1)|(1ULL<<FROM_NODE),
		/*A2*/  (1ULL<<A1)|(1ULL<<A3)|(1ULL<<B1)|(1ULL<<C1)|(1ULL<<FROM_NODE),
		/*A3*/  (1ULL<<A2)|(1ULL<<A4)|(1ULL<<B1)|(1ULL<<B2)|(1ULL<<C2)|(1ULL<<FROM_NODE),
		/*A4*/  (1ULL<<A3)|(0ULL<<B2)|(1ULL<<FROM_NODE),

		//Rangée [B]
		/*B1*/  (1ULL<<A1)|(1ULL<<A2)|(1ULL<<A3)|(1ULL<<C1)|(1ULL<<C2)|(1ULL<<D1)|(1ULL<<FROM_NODE),
		/*B2*/  (1ULL<<A3)|(1ULL<<A4)|(1ULL<<C2)|(1ULL<<D2)|(1ULL<<FROM_NODE),

		//Rangée [C]
		/*C1*/  (1ULL<<A1)|(1ULL<<A2)|(1ULL<<B1)|(1ULL<<D1)|(1ULL<<E1)|(1ULL<<FROM_NODE),
		/*C2*/  (1ULL<<A3)|(1ULL<<B1)|(1ULL<<B2)|(1ULL<<D1)|(1ULL<<D2)|(1ULL<<E2)|(1ULL<<FROM_NODE),

		//Rangée [D]
		/*D1*/  (1ULL<<B1)|(1ULL<<C1)|(1ULL<<C2)|(1ULL<<E1)|(1ULL<<E2)|(1ULL<<F1)|(1ULL<<FROM_NODE),
		/*D2*/  (1ULL<<B2)|(1ULL<<C2)|(1ULL<<E2)|(1ULL<<F2)|(1ULL<<FROM_NODE),

		//Rangée [E]
		/*E1*/  (1ULL<<C1)|(1ULL<<D1)|(1ULL<<F1)|(1ULL<<G1)|(1ULL<<FROM_NODE),
		/*E2*/  (1ULL<<C2)|(1ULL<<D1)|(1ULL<<D2)|(1ULL<<F1)|(1ULL<<F2)|(1ULL<<G2)|(1ULL<<FROM_NODE),

		//Rangée [F]
		/*F1*/  (1ULL<<D1)|(1ULL<<E1)|(1ULL<<E2)|(1ULL<<G1)|(1ULL<<G2)|(1ULL<<H1)|(1ULL<<FROM_NODE),
		/*F2*/  (1ULL<<D2)|(1ULL<<E2)|(1ULL<<G2)|(1ULL<<FROM_NODE),

		//Rangée [G]
		/*G1*/  (1ULL<<E1)|(1ULL<<F1)|(1ULL<<H1)|(1ULL<<I1)|(1ULL<<FROM_NODE),
		/*G2*/  (1ULL<<E2)|(1ULL<<F1)|(1ULL<<F2)|(1ULL<<H1)|(1ULL<<H2)|(1ULL<<I2)|(1ULL<<FROM_NODE),

		//Rangée [H]
		/*H1*/  (1ULL<<J1)|(1ULL<<I1)|(1ULL<<I2)|(1ULL<<G1)|(1ULL<<G2)|(1ULL<<F1)|(1ULL<<FROM_NODE),
		/*H2*/  (1ULL<<J2)|(1ULL<<I2)|(1ULL<<G2)|(1ULL<<FROM_NODE),

		//Rangée [I]
		/*I1*/  (1ULL<<K1)|(1ULL<<J1)|(1ULL<<H1)|(1ULL<<G1)|(1ULL<<FROM_NODE),
		/*I2*/  (1ULL<<K2)|(1ULL<<J1)|(1ULL<<J2)|(1ULL<<H1)|(1ULL<<H2)|(1ULL<<G2)|(1ULL<<FROM_NODE),

		//Rangée [J]
		/*J1*/  (1ULL<<L1)|(1ULL<<K1)|(1ULL<<K2)|(1ULL<<I1)|(1ULL<<I2)|(1ULL<<H1)|(1ULL<<FROM_NODE),
		/*J2*/  (1ULL<<L2)|(1ULL<<K2)|(1ULL<<I2)|(1ULL<<H2)|(1ULL<<FROM_NODE),

		//Rangée [K]
		/*K1*/  (1ULL<<M1)|(1ULL<<M2)|(1ULL<<L1)|(1ULL<<J1)|(1ULL<<I1)|(1ULL<<FROM_NODE),
		/*K2*/  (1ULL<<M3)|(1ULL<<L1)|(1ULL<<L2)|(1ULL<<J1)|(1ULL<<J2)|(1ULL<<I2)|(1ULL<<FROM_NODE),

		//Rangée [L]
		/*L1*/  (1ULL<<M1)|(1ULL<<M2)|(1ULL<<M3)|(1ULL<<K1)|(1ULL<<K2)|(1ULL<<J1)|(1ULL<<FROM_NODE),
		/*L2*/  (1ULL<<M3)|(1ULL<<M4)|(1ULL<<K2)|(1ULL<<J2)|(1ULL<<FROM_NODE),

		//Rangée [M]
		/*M1*/  (1ULL<<M2)|(1ULL<<L1)|(1ULL<<K1)|(1ULL<<FROM_NODE),
		/*M2*/  (1ULL<<M1)|(1ULL<<M3)|(1ULL<<L1)|(1ULL<<K1)|(1ULL<<FROM_NODE),
		/*M3*/  (1ULL<<M2)|(1ULL<<M4)|(1ULL<<L1)|(1ULL<<L2)|(1ULL<<K2)|(1ULL<<FROM_NODE),
		/*M4*/  (1ULL<<M3)|(0ULL<<L2)|(1ULL<<FROM_NODE),
...
//--------------------------------------------------------------------------------------------------------------------------------------
	...
	static void ASTAR_user_define_obstacles(){
		...
		// zone de départ adverse
		GEOMETRY_point_t poly_adv_start_zone[4] = {(GEOMETRY_point_t){300 - OBSTACLE_MARGIN, COLOR_Y(3000)},
												   (GEOMETRY_point_t){300 - OBSTACLE_MARGIN, COLOR_Y(2550 - OBSTACLE_MARGIN)},
												   (GEOMETRY_point_t){1200 + OBSTACLE_MARGIN, COLOR_Y(2550 - OBSTACLE_MARGIN)},
												   (GEOMETRY_point_t){1200 + OBSTACLE_MARGIN, COLOR_Y(3000)}};
		// COLOR_NODE(L1) et COLOR_NODE(L2) sont dans le polygone donc ces voisins seront ignorés
		astar_node_id nodesIO_adv_start_zone[6] = {COLOR_NODE(L1), COLOR_NODE(L2), COLOR_NODE(K1), COLOR_NODE(K2), COLOR_NODE(J1), COLOR_NODE(J2)};
		ASTAR_define_polygon("adv_start_zone", poly_adv_start_zone, 4, TRUE, nodesIO_adv_start_zone, 6);


		////////////////////////////////////////// DEFINITION DES HARDLINES ///////////////////////////////////////////////////////
		// Tasseau de bois séparant les balances
		ASTAR_define_hardline(FALSE,(GEOMETRY_point_t){1378 - HARDLINE_PROTECTION_LENGTH, 0}, (GEOMETRY_point_t){2000, 3000}, TRUE);
		// Mur au niveau des distributeurs (sud) - Marge de protection de HARDLINE_PROTECTION_LENGTH/2 sinon on ne passera jamais pour prendre le petit distributeur
		ASTAR_define_hardline(FALSE,(GEOMETRY_point_t){1600, 450 - HARDLINE_PROTECTION_LENGTH/2}, (GEOMETRY_point_t){1550 + HARDLINE_PROTECTION_LENGTH/2, 3000}, TRUE);
	...
	static void ASTAR_define_hardline(bool_e protection_extremity_1, GEOMETRY_point_t extremity_1, GEOMETRY_point_t extremity_2, bool_e protection_extremity_2){
		...
		if(protection_extremity_1){
			...
			angle = atan2_4096(extremity_2.y - extremity_1.y, extremity_2.x - extremity_1.x) + PI4096/2;
			astar_hardlines[astar_nb_hardlines].ex1.x = extremity_1.x + HARDLINE_PROTECTION_LENGTH*cos4096(angle);
			astar_hardlines[astar_nb_hardlines].ex1.y = extremity_1.y + HARDLINE_PROTECTION_LENGTH*sin4096(angle);
			astar_hardlines[astar_nb_hardlines].ex2.x = extremity_1.x - HARDLINE_PROTECTION_LENGTH*cos4096(angle);
			astar_hardlines[astar_nb_hardlines].ex2.y = extremity_1.y - HARDLINE_PROTECTION_LENGTH*sin4096(angle);
			astar_nb_hardlines++;
		...
		if(protection_extremity_2){
			...
			angle = atan2_4096(extremity_1.y - extremity_2.y, extremity_1.x - extremity_2.x) + PI4096/2;
			astar_hardlines[astar_nb_hardlines].ex1.x = extremity_2.x + HARDLINE_PROTECTION_LENGTH*cos4096(angle);
			astar_hardlines[astar_nb_hardlines].ex1.y = extremity_2.y + HARDLINE_PROTECTION_LENGTH*sin4096(angle);
			astar_hardlines[astar_nb_hardlines].ex2.x = extremity_2.x - HARDLINE_PROTECTION_LENGTH*cos4096(angle);
			astar_hardlines[astar_nb_hardlines].ex2.y = extremity_2.y - HARDLINE_PROTECTION_LENGTH*sin4096(angle);
			astar_nb_hardlines++;
			assert(astar_nb_hardlines <= NB_MAX_HARDLINES);
		}
	}
	...
	static void ASTAR_search_neighbors(astar_node_id nodeId, bool_e my_neighbors){
		...
		Uint8 tmpNodeId = 0;
		char node_id_str[10] = {0};

		if(nodeId == FROM_NODE) {
			strncpy(node_id_str, "FROM_NODE", 10);
		}

		if(nodeId == DEST_NODE) {
			strncpy(node_id_str, "DEST_NODE", 10);
		}
		...
		for(i=0; i<astar_nb_polygons; i++){
			if(astar_polygons[i].enable){
				...
				if(ASTAR_point_is_in_polygon(astar_polygons[i], astar_nodes[nodeId].pos)){
					...
					if(node_id_str != NULL) {
						error_printf("ERROR: %s is in polygon \"%s\"\n", node_id_str, astar_polygons[i].name);
					}
					for(j=0; j<astar_polygons[i].nb_nodesIO; j++){
						...
						if(!ASTAR_is_link_cut_by_hardlines(astar_nodes[nodeId].pos, astar_nodes[tmpNodeId].pos)){
							if(my_neighbors){
								...
								error_printf("Node=%d indexIO=%d pos=(%d, %d) ajoute comme voisin par FROM_NODE\n", tmpNodeId, j, astar_nodes[tmpNodeId].pos.x, astar_nodes[tmpNodeId].pos.y);
								ASTAR_ADD_NODE_IN(tmpNodeId, astar_nodes[nodeId].neighbors);
							}else{
								// Je cherche de qui je peut être voisin, les nodesIO du polygone m'ajoute comme voisin
								error_printf("Node=%d indexIO=%d pos=(%d, %d) ajoute comme voisin à DEST_NODE\n", tmpNodeId, j, astar_nodes[tmpNodeId].pos.x, astar_nodes[tmpNodeId].pos.y);
								ASTAR_ADD_NODE_IN(nodeId, astar_nodes[tmpNodeId].neighbors);
							}
						}else{
							if(node_id_str != NULL) {
								error_printf("Node=%d indexIO=%d (%d;%d) of polygon \"%s\" NOT neighbor (cut by hardline)\n", tmpNodeId, j, astar_nodes[tmpNodeId].pos.x, astar_nodes[tmpNodeId].pos.y , astar_polygons[i].name);
							} else {
								debug_printf("Node=%d indexIO=%d (%d;%d) of polygon \"%s\" NOT neighbor (cut by hardline)\n", tmpNodeId, j, astar_nodes[tmpNodeId].pos.x, astar_nodes[tmpNodeId].pos.y , astar_polygons[i].name);
							}
						}
					}
				}
			...
			do{
				...
				for(i=0; i<NB_NODES; i++){
					if(i != nodeId && astar_nodes[i].enable){
						dist = GEOMETRY_distance_square(astar_nodes[nodeId].pos, astar_nodes[i].pos);
	...
	static error_e ASTAR_make_the_path(displacement_curve_t *displacements, Uint8 *nb_displacements, PROP_speed_e speed, astar_node_id last_node){
		...
		*nb_displacements = j;
		...
		j = 1;
		for(i=1; i<nb_nodes-1; i++){
			if(ASTAR_is_node_visible(astar_nodes[path_id[last_index]].pos, astar_nodes[path_id[i+1]].pos) && i - last_index < 2){  // i - last_index < 2 to delete only 1 point each 2 points
				path_enable[i] = FALSE;
				debug_printf("Node %d deleted of path (%d;%d)\n", path_id[i], astar_nodes[path_id[i]].pos.x, astar_nodes[path_id[i]].pos.y);
			}else{
				last_index = i;
		...
		*nb_displacements = nb_nodes - 1;
		...
		if(nb_nodes >= 3 && ASTAR_is_node_visible(astar_nodes[FROM_NODE].pos, astar_nodes[path_id[2]].pos)
				&& GEOMETRY_distance_square(astar_nodes[FROM_NODE].pos, astar_nodes[path_id[1]].pos) <  DISTANCE_PROXIMITY_NODE*DISTANCE_PROXIMITY_NODE)
		{
			path_enable[1] = FALSE;
		...
		if(nb_nodes >= 3 && ASTAR_is_node_visible(astar_nodes[path_id[nb_nodes-3]].pos, astar_nodes[path_id[nb_nodes-1]].pos)
				&& GEOMETRY_distance_square(astar_nodes[path_id[nb_nodes-2]].pos, astar_nodes[path_id[nb_nodes-1]].pos) <  DISTANCE_PROXIMITY_NODE*DISTANCE_PROXIMITY_NODE)
		{
		...
		switch(state)
		{
				...
				switch(result)
				{
					...
					default:
						...
						if(nb_try == 0){
							...
							ASTAR_generate_graph(from, dest);
							if(foe_is_in_square(FALSE, global.pos.x - DIST_FOE_TO_EXTRACT, global.pos.x + DIST_FOE_TO_EXTRACT, global.pos.y - DIST_FOE_TO_EXTRACT, global.pos.y + DIST_FOE_TO_EXTRACT, FOE_TYPE_ALL)
			...
			case ASTAR_COMPUTE:
				...
				if(result == END_OK){
					...
					if(		nb_try > 0
							&& (avoidance == DODGE_AND_NO_WAIT || avoidance == DODGE_AND_WAIT)
							&& foe_is_in_square(FALSE, global.pos.x - DIST_FOE_TO_EXTRACT, global.pos.x + DIST_FOE_TO_EXTRACT, global.pos.y - DIST_FOE_TO_EXTRACT, global.pos.y + DIST_FOE_TO_EXTRACT, FOE_TYPE_ALL)
							)
					{
						state = ASTAR_DODGE_FOE;
