...
#define TIMEOUT_SELFTEST_ACT			60000	// en ms
	...
	switch(state)
	{
		...
		case WAIT_SELFTEST_LAUNCH:
			if(ask_launch_selftest)	//demande de lancement du selftest (PAS PENDANT LE MATCH !)
			{
				...
				CAN_send_sid(BROADCAST_SELFTEST_BEGIN);
			}
			break;
		case SELFTEST_STRAT:
			if(entrance)
		...
		case SELFTEST_END:
			CAN_send_sid(BROADCAST_SELFTEST_END);
			selftest_is_running = FALSE;
...
error_e SELFTEST_strategy(bool_e reset)
{
	...
	switch(state)
	{
		...
		case TEST_SWITCHS:
			//Exemple: if(IHM_switchs_get(SWITCH_DISABLE_CROSS_TAKER_FRONT))		SELFTEST_declare_errors(NULL, SELFTEST_STRAT_SWITCH_DISABLE_CROSS_TAKER_FRONT);
			if(IHM_switchs_get(SWITCH_DISABLE_ACT_ELEVATOR))		SELFTEST_declare_errors(NULL, SELFTEST_STRAT_SWITCH_DISABLE_ACT_ELEVATOR);
			if(IHM_switchs_get(SWITCH_DISABLE_ACT_SORTING))			SELFTEST_declare_errors(NULL, SELFTEST_STRAT_SWITCH_DISABLE_ACT_SORTING);
			state = TEST_SD_CARD;
			break;
	...
	for(i=0;i<size;i++)
	{
		if(errors[i] != SELFTEST_NO_ERROR)
		{
			...
			switch(errors[i])
			{
				...
				// Switchs
				case SELFTEST_STRAT_SWITCH_DISABLE_ACT_ELEVATOR:		debug_printf("SELFTEST_STRAT_SWITCH_DISABLE_ACT_ELEVATOR");		break;
				case SELFTEST_STRAT_SWITCH_DISABLE_ACT_SORTING:			debug_printf("SELFTEST_STRAT_SWITCH_DISABLE_ACT_SORITNG");		break;

				// Actionneurs BIG
                //case SELFTEST_ACT_EXEMPLE:							debug_printf("SELFTEST_ACT_EXEMPLE");           				break;
				case SELFTEST_ACT_BIG_LOCKER_FRONT_LEFT:				debug_printf("SELFTEST_ACT_BIG_LOCKER_FRONT_LEFT");           	break;
				case SELFTEST_ACT_BIG_LOCKER_FRONT_MIDDLE:				debug_printf("SELFTEST_ACT_BIG_LOCKER_FRONT_MIDDLE");          	break;
				case SELFTEST_ACT_BIG_LOCKER_FRONT_RIGHT:				debug_printf("SELFTEST_ACT_BIG_LOCKER_FRONT_RIGHT");           	break;
				case SELFTEST_ACT_BIG_ELEVATOR_FRONT_LEFT:				debug_printf("SELFTEST_ACT_BIG_ELEVATOR_FRONT_LEFT");        	break;
				case SELFTEST_ACT_BIG_ELEVATOR_FRONT_MIDDLE:			debug_printf("SELFTEST_ACT_BIG_ELEVATOR_FRONT_MIDDLE");         break;
				case SELFTEST_ACT_BIG_ELEVATOR_FRONT_RIGHT:				debug_printf("SELFTEST_ACT_BIG_ELEVATOR_FRONT_RIGHT");          break;
				case SELFTEST_ACT_BIG_SORTING_BACK_VERY_LEFT:			debug_printf("SELFTEST_ACT_BIG_SORTING_BACK_VERY_LEFT");        break;
				case SELFTEST_ACT_BIG_SORTING_BACK_LEFT:				debug_printf("SELFTEST_ACT_BIG_SORTING_BACK_LEFT");           	break;
				case SELFTEST_ACT_BIG_SORTING_BACK_RIGHT:				debug_printf("SELFTEST_ACT_BIG_SORTING_BACK_RIGHT");           	break;
				case SELFTEST_ACT_BIG_SORTING_BACK_VERY_RIGHT:			debug_printf("SELFTEST_ACT_BIG_SORTING_BACK_VERY_RIGHT");       break;
				case SELFTEST_ACT_BIG_SLOP_TAKER_BACK:					debug_printf("SELFTEST_ACT_BIG_SLOP_TAKER_BACK");           	break;
...
void SELFTEST_check_alim(){
	...
	if(global.alim_value == 0 && global.absolute_time - begin_time >= TIME_TO_REFRESH_BAT && !responsability_of_alim){
...
char * SELFTEST_getError_string(SELFTEST_error_code_e error_num){
	...
	switch(error_num){
		...
		// Switchs
		//Ex: case SELFTEST_STRAT_SWITCH_DISABLE_CROSS_TAKER_FRONT:      	return "Switch DISABLE_CROSS_FRONT activated";		break;


		// Actionneurs BIG
		// Ex: case SELFTEST_ACT_BIG_CROSS_TAKER_FRONT:      	return "Cross Taker Front";     	break;
		case SELFTEST_ACT_BIG_LOCKER_FRONT_LEFT:		return "LOCKER_FRONT_LEFT failed";			break;
		case SELFTEST_ACT_BIG_LOCKER_FRONT_MIDDLE:		return "LOCKER_FRONT_MIDDLE failed";		break;
		case SELFTEST_ACT_BIG_LOCKER_FRONT_RIGHT:		return "LOCKER_FRONT_RIGHT failed";			break;
		case SELFTEST_ACT_BIG_ELEVATOR_FRONT_LEFT:		return "ELEVATOR_FRONT_LEFT failed";		break;
		case SELFTEST_ACT_BIG_ELEVATOR_FRONT_MIDDLE:	return "ELEVATOR_FRONT_MIDDLE failed";		break;
		case SELFTEST_ACT_BIG_ELEVATOR_FRONT_RIGHT:		return "ELEVATOR_FRONT_RIGHT failed";		break;
		case SELFTEST_ACT_BIG_SORTING_BACK_VERY_LEFT:	return "SORTING_BACK_VERY_LEFT failed";		break;
		case SELFTEST_ACT_BIG_SORTING_BACK_LEFT:		return "SORTING_BACK_LEFT failed";			break;
		case SELFTEST_ACT_BIG_SORTING_BACK_RIGHT:		return "SORTING_BACK_RIGHT failed";			break;
		case SELFTEST_ACT_BIG_SORTING_BACK_VERY_RIGHT:	return "SORTING_BACK_VERY_RIGHT failed";	break;
		case SELFTEST_ACT_BIG_SLOP_TAKER_BACK:			return "SLOP_TAKER_BACK failed";			break;
