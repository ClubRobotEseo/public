 ...
 */
...
#ifndef IMPL_MOSFET_H
	#define	IMPL_MOSFET_H
	 ...
	 * @param actuator_gen_ptr l'instance de l'actionneur (sous forme de pointeur generique).
	 */
	//void IMPL_MOSFET_reset_config(void* actuator_gen_ptr);
	 ...
	 */
	void IMPL_MOSFET_run_command(queue_id_t queueId, void* actuator_gen_ptr, bool_e init);
