...
junction.exe -d 2_Strategie\StratEasy\QS
junction.exe -d 2_Strategie\StratEasy\stm32f4xx
...
junction.exe -d 7_BeaconEye/CurrentSoftware/QS
junction.exe -d 7_BeaconEye/CurrentSoftware/stm32f4xx
...
junction.exe -d R_D\ActExpander\CurrentSoftware\QS
junction.exe -d R_D\ActExpander\CurrentSoftware\stm32f4xx
junction.exe -d R_D\ToolKit\src\QS
