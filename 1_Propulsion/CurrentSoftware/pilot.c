...
void PILOT_init(void)
{
	...
	if(QS_WHO_AM_I_get()==SMALL_ROBOT)
	{
		...
		coefs[PILOT_ACCELERATION_MAX]						= SMALL_ACCELERATION_MAX;
		coefs[PILOT_ACCELERATION_ROTATION_TRANSLATION]		= SMALL_ACCELERATION_ROTATION_TRANSLATION;
		coefs[PILOT_ACCELERATION_ROTATION_TRANSLATION_MAX] 	= SMALL_ACCELERATION_ROTATION_TRANSLATION_MAX;
	...
	else
	{
		...
		coefs[PILOT_ACCELERATION_MAX]						= BIG_ACCELERATION_MAX;
		coefs[PILOT_ACCELERATION_ROTATION_TRANSLATION]		= BIG_ACCELERATION_ROTATION_TRANSLATION;
		coefs[PILOT_ACCELERATION_ROTATION_TRANSLATION_MAX]	= BIG_ACCELERATION_ROTATION_TRANSLATION_MAX;
...
static void PILOT_reset_default_coef(PILOT_coef_e id)
{
	...
	if(QS_WHO_AM_I_get()==SMALL_ROBOT)
	{
		switch(id)
		{
			...
			case PILOT_ACCELERATION_MAX:						coefs[id] 	= SMALL_ACCELERATION_MAX;						break;
			case PILOT_ACCELERATION_ROTATION_TRANSLATION:		coefs[id] 	= SMALL_ACCELERATION_ROTATION_TRANSLATION;		break;
			case PILOT_ACCELERATION_ROTATION_TRANSLATION_MAX: 	coefs[id] 	= SMALL_ACCELERATION_ROTATION_TRANSLATION_MAX;	break;
	...
	else
	{
		switch(id)
		{
			...
			case PILOT_ACCELERATION_MAX:						coefs[id] 	= BIG_ACCELERATION_MAX;							break;
			case PILOT_ACCELERATION_ROTATION_TRANSLATION:		coefs[id] 	= BIG_ACCELERATION_ROTATION_TRANSLATION;		break;
			case PILOT_ACCELERATION_ROTATION_TRANSLATION_MAX:	coefs[id] 	= BIG_ACCELERATION_ROTATION_TRANSLATION_MAX;	break;
...
static void PILOT_update_acceleration_translation_and_rotation(void) {
	...
	if(coef_acceleration_translation > coefs[PILOT_ACCELERATION_MAX])
		coef_acceleration_translation = coefs[PILOT_ACCELERATION_MAX];
	...
	// Coef_acceleration rotation translation
	if(coefs[PILOT_ACCELERATION_ROTATION_TRANSLATION] > coefs[PILOT_ACCELERATION_ROTATION_TRANSLATION_MAX])
		coef_acceleration_rotation_translation = coefs[PILOT_ACCELERATION_ROTATION_TRANSLATION_MAX];
	else
		coef_acceleration_rotation_translation = coefs[PILOT_ACCELERATION_ROTATION_TRANSLATION];

	//ce coeff dï¿½pend de la distance entre les roues de propulsions...
	global.acceleration_rotation *= coef_acceleration_rotation_translation;
}
