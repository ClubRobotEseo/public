...
static volatile bool_e alreadyStoppedCalculationViewingAngle = FALSE;
...
static void COPILOT_do_order(order_t * order)
{
	...
	already_braking_rotation = NOT_BRAKING;
	already_braking_translation = NOT_BRAKING;
	alreadyStoppedCalculationViewingAngle = FALSE;
...
static void COPILOT_update_destination_rotation(void)
{
	...
	if(absolute(PILOT_get_destination_translation()) <= THRESHOLD_STOPPING_CALCULATION_VIEWING_ANGLE){
		alreadyStoppedCalculationViewingAngle = TRUE;
	}
