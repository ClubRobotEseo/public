...
//Consultez le Fichier: svn\propulsion\Documentation\TUTO_reglage_odometrie.txt
	...
	#define SMALL_ODOMETRY_COEF_TRANSLATION_DEFAULT 0x0C05

	#define BIG_ODOMETRY_COEF_TRANSLATION_DEFAULT	0x0BCA
	...
	#define SMALL_ODOMETRY_COEF_ROTATION_DEFAULT	0x00018E3E
	#define BIG_ODOMETRY_COEF_ROTATION_DEFAULT		0x0000A5BE
	...
	#define SMALL_ODOMETRY_COEF_SYM_DEFAULT 0xFFFFFFFE//0xFFFFF6CF
	#define BIG_ODOMETRY_COEF_SYM_DEFAULT	0xFFFFFF84
...
//*********************************** POSITIONS CALIBRATIONS 2019 ******************************
	//SMALL
		//BOT_COLOR
		#define SMALL_BOT_COLOR_CALIBRATION_X  		450
		#define SMALL_BOT_COLOR_CALIBRATION_Y  		(450 - SMALL_CALIBRATION_BACKWARD_BORDER_DISTANCE - 10)
		#define SMALL_BOT_COLOR_CALIBRATION_TETA	(-PI4096/2)

		//TOP_COLOR
		#define SMALL_TOP_COLOR_CALIBRATION_X  		450
		#define SMALL_TOP_COLOR_CALIBRATION_Y  		(2550 + SMALL_CALIBRATION_BACKWARD_BORDER_DISTANCE + 10)
		#define SMALL_TOP_COLOR_CALIBRATION_TETA	(PI4096/2)

	//BIG
		//BOT_COLOR
		#define BIG_BOT_COLOR_CALIBRATION_X  		(750)
		#define BIG_BOT_COLOR_CALIBRATION_Y  		(450 - BIG_CALIBRATION_BACKWARD_BORDER_DISTANCE - 10)
		#define BIG_BOT_COLOR_CALIBRATION_TETA		(-PI4096/2)

		//TOP_COLOR
		#define BIG_TOP_COLOR_CALIBRATION_X  		(750)
		#define BIG_TOP_COLOR_CALIBRATION_Y  		(2550 + BIG_CALIBRATION_BACKWARD_BORDER_DISTANCE + 10)
		#define BIG_TOP_COLOR_CALIBRATION_TETA 		(PI4096/2)


//*********************************** POSITIONS INITIALES 2019 ******************************
	//SMALL
		// BOT_COLOR
		#define SMALL_BOT_COLOR_START_X  		((450)*65536)
		#define SMALL_BOT_COLOR_START_Y			((SMALL_CALIBRATION_FORWARD_BORDER_DISTANCE)*65536)
		#define SMALL_BOT_COLOR_START_TETA 		(-(PI4096/2)*65536)		// (il part en marche arrière...)

		// TOP_COLOR
		#define SMALL_TOP_COLOR_START_X 		((450)*65536)
		#define SMALL_TOP_COLOR_START_Y 		((3000 - SMALL_CALIBRATION_FORWARD_BORDER_DISTANCE)*65536)
		#define SMALL_TOP_COLOR_START_TETA 		((PI4096/2)*65536)		// (il part en marche arrière...)

	//BIG
		// BOT_COLOR
		#define BIG_BOT_COLOR_START_X			((750)*65536)
		#define BIG_BOT_COLOR_START_Y			((BIG_CALIBRATION_FORWARD_BORDER_DISTANCE)*65536)
		#define BIG_BOT_COLOR_START_TETA		(-(PI4096/2)*65536)		// PI_28  (il part en marche arrière...)

		// TOP_COLOR
		#define BIG_TOP_COLOR_START_X			((750)*65536)
		#define BIG_TOP_COLOR_START_Y			((3000 - BIG_CALIBRATION_FORWARD_BORDER_DISTANCE)*65536)
		#define BIG_TOP_COLOR_START_TETA		((PI4096/2)*65536)		// PI_28  (il part en marche arrière...)




////////EQUILIBRAGE DES MOTEURS///////////////
	#define SMALL_BALANCING_MOTOR	1024
	#define BIG_BALANCING_MOTOR		950
...
////////REGLAGES DU CORRECTEUR PD////////////////////////
	...
	#define BIG_KP_TRANSLATION		(0x28)//(0x28)//(0x30)//(0x28)
	...
	#define BIG_KD_ROTATION			(0x280)//(0x380) //(0xA00)//(0x280)//(0x08) //0x800
	...
	#define BIG_KV_ROTATION			1 //85	//CHOMP 1

	#define SMALL_KV_TRANSLATION 	19
	#define BIG_KV_TRANSLATION		13//12

	#if CORRECTOR_ENABLE_ACCELERATION_ANTICIPATION
	...
	#else
		#define SMALL_KA_ROTATION		0
		#define BIG_KA_ROTATION			0//8

		#define SMALL_KA_TRANSLATION 	0
		#define BIG_KA_TRANSLATION		0//300
	#endif
...
/////GESTION_TRAJECTOIRES/////////////////////////////
	...
	#define SMALL_ACCELERATION_ROTATION					500
	#define SMALL_ACCELERATION_ROTATION_MAX				500



	#define BIG_ACCELERATION_NORMAL						100		//[mm.4096/5ms/5ms] ATTENTION : doit être un multiple de 16...
	#define BIG_ACCELERATION_MAX						256		//[mm.4096/5ms/5ms]
	...
	#define BIG_ACCELERATION_ROTATION_TRANSLATION_MAX	13//13		//[rad.1024/mm]

	#define BIG_ACCELERATION_ROTATION					4000
	#define BIG_ACCELERATION_ROTATION_MAX				6300
	...
	// Unité : [mm.4096/5ms]
	#define SMALL_TRANSLATION_SPEED_LIGHT		(Sint32)(30000) 		//environ = 7,32[mm/5ms] = 1,46m/s
	#define SMALL_TRANSLATION_SPEED_MAX 		(Sint32)(20480)			//environ = 5[mm/5ms] = 1m/s
	...
	// ATTENTION !!!!!!!!!!!!!!!!!!!!!!!! les valeurs ci-dessous doivent être multiples des accélérations...
	// Unité : [mm.4096/5ms]
	#define BIG_TRANSLATION_SPEED_LIGHT			(Sint32)(36864) 		//environ = 10[mm/5ms] = 1,91m/s
	...
	//Une vitesse de 1024[rad.4096.1024/5ms] en rotation correspond à un déplacement des roues de 80[mm.4096/5ms]
	// Unité : [rad.4096.1024/5ms]
	#define BIG_ROTATION_SPEED_LIGHT			(Sint32)(67580)			//environ 6,4 rad/s
	#define BIG_ROTATION_SPEED_MAX				(Sint32)(67580)			//environ 6,4 rad/s
...
///////////SEUIL_ERREUR/////////////////////////////////
	...
	#undef BIG_ODOMETRY_COEF_TRANSLATION_DEFAULT
	#undef BIG_ODOMETRY_COEF_ROTATION_DEFAULT
	#undef BIG_ODOMETRY_COEF_SYM_DEFAULT
	#undef BIG_ODOMETRY_COEF_CENTRIFUGAL_DEFAULT
	#undef BIG_BOT_COLOR_START_X
	#undef BIG_TOP_COLOR_START_X
	#undef BIG_BALANCING_MOTOR
	#undef BIG_KD_TRANSLATION
	#undef BIG_KP_TRANSLATION
	#undef BIG_KD_ROTATION
	#undef BIG_KP_ROTATION
	#undef BIG_KI_ROTATION
	#undef BIG_KV_ROTATION
	#undef BIG_KV_TRANSLATION
	#if CORRECTOR_ENABLE_ACCELERATION_ANTICIPATION
		#warning "mode non utilisé jusqu'à maintenant : coefs non reglés"
		#undef BIG_KA_ROTATION
		#undef BIG_KA_TRANSLATION
	#else
		#undef BIG_KA_ROTATION
		#undef BIG_KA_TRANSLATION
	#endif

	#undef BIG_ACCELERATION_ROTATION_TRANSLATION
	#undef BIG_ACCELERATION_ROTATION_TRANSLATION_MAX

	#undef BIG_TRANSLATION_SPEED_LIGHT		//environ = 10[mm/5ms] = 1,91m/s
	#undef BIG_ROTATION_SPEED_LIGHT	//environ 6,4 rad/s
	#undef BIG_ROTATION_SPEED_MAX		//environ 6,4 rad/s


	#define BIG_ODOMETRY_COEF_TRANSLATION_DEFAULT	0x0C37
	#define BIG_ODOMETRY_COEF_ROTATION_DEFAULT		0x0000AD40
	#define BIG_ODOMETRY_COEF_SYM_DEFAULT	0xFFFFFFF7
	#define BIG_ODOMETRY_COEF_CENTRIFUGAL_DEFAULT (0) //128/(rad*4096*64) si on considère que les "speed" sont en fait des distances sinon c'est 128*ms*ms/(rad*4096*64)
	#define BIG_BOT_COLOR_START_X			(BIG_CALIBRATION_BACKWARD_BORDER_DISTANCE*65536)//avec les 2 barres de 8 mm
	#define BIG_TOP_COLOR_START_X			(BIG_CALIBRATION_BACKWARD_BORDER_DISTANCE*65536)//avec les 2 barres de 8 mm
	#define BIG_BALANCING_MOTOR		950
	#define BIG_KD_TRANSLATION		(0x20)//(0x1C) //0x80
	#define BIG_KP_TRANSLATION		(0x28)//(0x28)//(0x30)//(0x28)
	#define BIG_KD_ROTATION			(0x280)//(0x380) //(0xA00)//(0x280)//(0x08) //0x800
